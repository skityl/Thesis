...
\label{GroupActions} % For referencing this appendix elsewhere, use \ref{AppendixA}

\lhead{Appendix \ref{GroupActions}. \emph{Group Actions on Von Neumann Algebras}} % This is for the header on each page - perhaps a shortened title
